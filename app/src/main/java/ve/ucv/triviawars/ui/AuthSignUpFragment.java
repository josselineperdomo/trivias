...
import ve.ucv.triviawars.viewmodels.AuthSignUpViewModel;
import ve.ucv.triviawars.R;

public class AuthSignUpFragment extends Fragment {

    private AuthSignUpViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AuthSignUpViewModel.class);
